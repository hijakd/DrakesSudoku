...
import com.gdd.drakessudoku.ui.components.SudokuGrid
...
fun AppCore(modifier: Modifier = Modifier) {
    ...
    /* Rows == x's, Columns == y's *//* x1y1 x2y1 x3y1 */  /* x4y1 x5y1 x6y1 */  /* x7y1 x8y1 x9y1 *//* x1y2 x2y2 x3y2 */  /* x4y2 x5y2 x6y2 */  /* x7y2 x8y2 x9y2 *//* x1y3 x2y3 x3y3 */  /* x4y3 x5y3 x6y3 */  /* x7y3 x8y3 x9y3 */

    /* x1y4 x2y4 x3y4 */  /* x4y4 x5y4 x6y4 */  /* x7y4 x8y4 x9y4 *//* x1y5 x2y5 x3y5 */  /* x4y5 x5y5 x6y5 */  /* x7y5 x8y5 x9y5 *//* x1y6 x2y6 x3y6 */  /* x4y6 x5y6 x6y6 */  /* x7y6 x8y6 x9y6 */

    /* x1y7 x2y7 x3y7 */  /* x4y7 x5y7 x6y7 */  /* x7y7 x8y7 x9y7 *//* x1y8 x2y8 x3y8 */  /* x4y8 x5y8 x6y8 */  /* x7y8 x8y8 x9y8 *//* x1y9 x2y9 x3y9 */  /* x4y9 x5y9 x6y9 */  /* x7y9 x8y9 x9y9 */
    ...
    shuffled.removeAt(0)/* x1y5 */
    val x1y5 = shuffled.first()
    shuffled.removeAt(0)/* x1y6 */
    val x1y6 = shuffled.first()
    shuffled.removeAt(0)

    /* x1y7 */
    val x1y7 = shuffled.first()
    shuffled.removeAt(0)/* x1y8 */
    val x1y8 = shuffled.first()
    shuffled.removeAt(0)/* x1y9 */
    ...
    /* row 2 */
    slice1.clear()/* filter out values in row 2 of Grid1 */
    shuffled.forEach {
    ...
    /* x4y3 */
    val x4y3 = if (slice2.first() != x4y2 && slice2.first() != x5y2 && slice2.first() != x6y2) {
        slice2.first()
    } else {
        slice2.last()
    }
    ...
    /* x5y3 */
    val x5y3 = if (slice2.first() != x4y2 && slice2.first() != x4y3 && slice2.first() != x5y2 && slice2.first() != x6y2) {
        slice2.first()
    } else {
        slice2.last()
    }
    ...
    /* x6y3 */
    val x6y3 =
        if (slice2.first() != x4y2 && slice2.first() != x4y3 && slice2.first() != x5y2 && slice2.first() != x5y3 && slice2.first() != x6y2) {
            slice2.first()
        } else {
            slice2.last()
        }
    ...
    /* Grid3 TopRight */
    shuffled.clear()/* filter out values in row 1 of Grid3 */
    numbers.forEach {
    ...
    shuffled.remove(x7y2) // slice1.remove(x7y2)
    ...
    /* row 3 */
    slice2.clear()/* filter out values in row 2 of Grid1 */
    shuffled.forEach {
    ...
    Column(modifier = modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Spacer(modifier = Modifier.size(5.dp)) // Text("Grid# $grid")
        // Text("idx# $tmp")
