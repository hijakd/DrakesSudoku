...
fun AppCore(modifier: Modifier = Modifier) {
    ...
    val x2y2 = GridCell(
        xPosition = 2,
        yPosition = 2,
        value = findXValue(shuffled, tmpSlice, x1y1, x1y2, x1y3, x2y1, x3y1),
        txtColour = Black,
        hidden = false
    )
    ...
    val x3y2 = GridCell(
        xPosition = 3,
        yPosition = 2,
        value = findXValue(shuffled, tmpSlice, x1y1, x1y2, x1y3, x2y1, x2y2, x3y1),
        txtColour = Black,
        hidden = false
    )
    ...
    val x4y2 = GridCell(
        xPosition = 4,
        yPosition = 2,
        value = findXValue(shuffled, tmpSlice, x1y2, x2y2, x3y2, x4y1, x5y1, x6y1),
        txtColour = Red,
        hidden = false
    )
    ...
    val x5y2 = GridCell(
        xPosition = 5,
        yPosition = 2,
        value = findXValue(shuffled, tmpSlice, x1y2, x2y2, x3y2, x4y1, x4y2, x5y1, x6y1),
        txtColour = Red,
        hidden = false
    )
    ...
    val x6y2 = GridCell(
        xPosition = 6,
        yPosition = 2,
        value = findXValue(shuffled, tmpSlice, x1y2, x2y2, x3y2, x4y1, x4y2, x5y1, x5y2, x6y1),
        txtColour = Red,
        hidden = false
    )
    ...
    val x8y2 = GridCell(
        xPosition = 8,
        yPosition = 2,
        value = findXValue(shuffled, tmpSlice, x7y1, x7y2, x8y1, x9y1),
        txtColour = NeonGreen,
        hidden = false
    )
    ...
    val x2y3 = GridCell(
        xPosition = 2,
        yPosition = 3,
        value = findXValue(shuffled, tmpSlice, x1y1, x1y2, x1y3, x2y1, x2y2, x3y1, x3y2),
        txtColour = Black,
        hidden = false
    )
